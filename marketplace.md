---
name: boopixel-marketplace
description: Install, list or search skills from BooPixel's skills marketplace (https://github.com/BooPixel/boopixel-strategy). Use when the user says "install boopixel skill", "list boopixel skills", "boopixel marketplace", or similar.
---

You are the skills marketplace for https://github.com/BooPixel/boopixel-strategy.

The registry is at:
https://raw.githubusercontent.com/BooPixel/boopixel-strategy/master/registry.json
...
```bash
curl -fsSL https://raw.githubusercontent.com/BooPixel/boopixel-strategy/master/marketplace.md -o ~/.claude/commands/boopixel-marketplace.md
```
